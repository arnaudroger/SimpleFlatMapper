...
#https://download.java.net/java/jdk10/archive/43/BCL/jdk-10+43_linux-x64_bin.tar.gz
cd ~
wget https://download.java.net/java/jdk${JDK_FEATURE}/archive/${JDK_BUILD}/BCL/${JDK_ARCHIVE}
tar -xzf ${JDK_ARCHIVE}
