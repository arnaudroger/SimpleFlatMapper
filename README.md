...
# Simple Flat Mapper (SFM) [v1.0.0rc2](https://github.com/arnaudroger/SimpleFlatMapper/wiki/SimpleFlatMapper-v1.0.0rc2)
...
Object will most of the time match the structure of a query or a csv. But is still allow you to customized the mapping
definition. [More details.](wiki/Property-Mapping)
...
fastest would be Roma that add between 10 and 15%. MyBatis and Hibernate adds more that 70% climbing quickly to 150%/470%
for bigger queries.
...
[More details.](wiki/Performance-Java-7)
