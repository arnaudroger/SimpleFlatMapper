...
java9 && git reset --hard && mvn clean install -Pdev9 && java8 && git reset --hard && mvn clean install -Pdev && java7 && git reset --hard && mvn clean install && java6 && git reset --hard && mvn clean install && git reset --hard
