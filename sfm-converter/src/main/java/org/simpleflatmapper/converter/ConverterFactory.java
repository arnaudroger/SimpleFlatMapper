...
import org.simpleflatmapper.converter.joda.JodaTimeConverterFactory;
import org.simpleflatmapper.util.date.joda.JodaTimeHelper;

//IFJAVA8_START
import org.simpleflatmapper.converter.time.JavaTimeConverterFactory;
...
public class ConverterFactory {
	...
	public static <P, F> Converter<F, P> getConverter(Class<F> inType, Type outType, Object... params) {
		...
		} else if (JodaTimeHelper.isJoda(inType)) {
