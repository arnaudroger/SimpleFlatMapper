                        ...
                        if (!headConverters.isEmpty()) {
                            ...
                            if (!tailConverters.isEmpty()) {
                                for(ScoredConverterFactory hf : headConverters) {
                                    if (hf.converterFactory.newConverter(new ConvertingTypes(inType, tailFactoryInType), EmptyContextFactoryBuilder.INSTANCE, params) != null) {
                                        for(ScoredConverterFactory tf : tailConverters) {
                                            if (hf.converterFactory.newConverter(new ConvertingTypes(tailFactoryInType, outType), EmptyContextFactoryBuilder.INSTANCE, params) != null) {
