...
import org.simpleflatmapper.core.reflect.impl.BuilderInstantiator;
import org.simpleflatmapper.core.reflect.impl.EmptyConstructorInstantiator;
import org.simpleflatmapper.core.reflect.impl.EmptyStaticMethodInstantiator;
import org.simpleflatmapper.core.reflect.impl.InjectConstructorInstantiator;
import org.simpleflatmapper.core.reflect.impl.InjectStaticMethodInstantiator;
...
public class InstantiatorFactory {
	...
	public <S, T, K extends FieldKey<K>, D extends ColumnDefinition<K, D>> Instantiator<S,T> getInstantiator(Type source, Type target, PropertyMappingsBuilder<T, K, D> propertyMappingsBuilder, Map<org.simpleflatmapper.core.reflect.Parameter, Getter<? super S, ?>> constructorParameterGetterMap,  org.simpleflatmapper.core.map.GetterFactory<? super S, K> getterFactory) throws NoSuchMethodException {
		return  getInstantiator(source, target, propertyMappingsBuilder, constructorParameterGetterMap, getterFactory, true);
	}

	@SuppressWarnings("unchecked")
    public <S, T, K extends FieldKey<K>, D extends ColumnDefinition<K, D>> Instantiator<S,T> getInstantiator(Type source, Type target, PropertyMappingsBuilder<T, K, D> propertyMappingsBuilder, Map<org.simpleflatmapper.core.reflect.Parameter, Getter<? super S, ?>> constructorParameterGetterMap, final  org.simpleflatmapper.core.map.GetterFactory<? super S, K> getterFactory,  boolean useAsmIfEnabled) throws NoSuchMethodException {
	...
	@SuppressWarnings("unchecked")
	public <S, T> Instantiator<S, T> getInstantiator(Type target, final Class<?> source, List<InstantiatorDefinition> constructors, Map<org.simpleflatmapper.core.reflect.Parameter, Getter<? super S, ?>> injections, boolean useAsmIfEnabled) throws SecurityException {
	...
	public <S, T> Instantiator<S, T> getOneArgIdentityInstantiator(InstantiatorDefinition id) {
		Map<org.simpleflatmapper.core.reflect.Parameter, Getter<? super S, ?>> injections = new HashMap<org.simpleflatmapper.core.reflect.Parameter, Getter<? super S, ?>>();
