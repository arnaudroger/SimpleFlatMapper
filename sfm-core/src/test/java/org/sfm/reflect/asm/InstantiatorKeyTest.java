...
public class InstantiatorKeyTest {
    ...
    public void testEqualsOnSameSourceAndTargetAndInjectParamValues() throws NoSuchMethodException {
        ...
        InstantiatorKey k1 = new InstantiatorKey(DbObject.class.getConstructor(), tuple2s, Date.class);
        InstantiatorKey k2 = new InstantiatorKey(DbObject.class.getConstructor(), tuple2s, Date.class);
        assertTrue(k1.equals(k2));
    }
    ...
    public void testNotEqualsOnSameSourceAndTargetAndDiffInjectParamValues() throws NoSuchMethodException {
        InstantiatorKey k1 = new InstantiatorKey(DbObject.class.getConstructor(), createTuple2("param"), Date.class);
        InstantiatorKey k2 = new InstantiatorKey(DbObject.class.getConstructor(), createTuple2("param2"), Date.class);
        InstantiatorKey k3 = new InstantiatorKey(DbObject.class.getConstructor(), null, Date.class);
        InstantiatorKey k4 = new InstantiatorKey(DbObject.class.getConstructor(), createTuple2("param", IntGetter.class), Date.class);
        assertFalse(k1.equals(k2));
        assertFalse(k1.equals(k3));
        assertFalse(k3.equals(k1));
    ...
    public void testNotEqualsDiffConstructor() throws NoSuchMethodException {
        InstantiatorKey k1 = new InstantiatorKey(DbObject.class.getConstructor(), createTuple2("param"), Date.class);
        InstantiatorKey k2 = new InstantiatorKey(DbFinalObject.class.getDeclaredConstructors()[0], createTuple2("param"), Date.class);
        InstantiatorKey k3 = new InstantiatorKey(null, createTuple2( "param"), Date.class);
        assertFalse(k1.equals(k2));
        assertFalse(k1.equals(k3));
        assertFalse(k3.equals(k1));
    }
