...
public class AbstractDatastaxTest  {
    ...
    protected void testInSession(Callback callback) throws Exception {
        ...
        try {
            ...
            session.execute("truncate dbobjects_set");
            ...
            session.execute("truncate dbobjects_list");
            ...
            session.execute("truncate dbobjects_map");
            ...
            session.execute("truncate dbobjects_mapll");
            ...
            session.execute("truncate dbobjects_tuple");
            ...
            session.execute("truncate dbobjects_udt");
            ...
            session.execute("truncate dbobjects_udttyplelist");
            ...
            session.execute("truncate dbobjects_listint");
            ...
            session.execute("truncate dbobjects_setint");
            ...
            session.execute("truncate dbobjects_listudt");
            ...
            session.execute("truncate dbobjects_listtuple");
            ...
            session.execute("truncate dbobjects_setudt");
            ...
            session.execute("truncate dbobjects_mapudt");
