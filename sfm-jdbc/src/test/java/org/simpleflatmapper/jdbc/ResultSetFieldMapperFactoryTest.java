...
public class ResultSetFieldMapperFactoryTest {
	...
	public void testPrimitiveField() {
		...
		PropertyMeta<DbObject, Long> id = classMeta.newPropertyFinder(ConstantPredicate.truePredicate()).<Long>findProperty(new DefaultPropertyNameMatcher("id", 0, false, false));
