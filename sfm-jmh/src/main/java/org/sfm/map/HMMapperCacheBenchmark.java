...
public class HMMapperCacheBenchmark {
    ...
    @Param("10")
    private int size;
    private HMMapperCache<JdbcColumnKey, Object> mapperCache;
    ...
    public static void main(String[] args) {
        HMMapperCacheBenchmark b = new HMMapperCacheBenchmark();
        b.size = 10;
        b.maxColumns = 10;
        b.setUp();
