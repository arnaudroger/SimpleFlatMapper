...
public class SortedMapperCacheBenchmark {
    ...
    @Param("10")
    private int size;
    private SortedMapperCache<JdbcColumnKey, Object> mapperCache;
    ...
    @Setup
    public void setUp() {
        mapperCache = new SortedMapperCache<>(MAPPER_KEY_COMPARATOR);
    ...
    public static void main(String[] args) {
        SortedMapperCacheBenchmark b = new SortedMapperCacheBenchmark();
        b.size = 10;
        b.maxColumns = 10;
        b.setUp();
