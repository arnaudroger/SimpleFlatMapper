...
public final class CharacterFieldMapper<S, T> implements FieldMapper<S, T> {
	...
	private final CharacterFieldMapperGetter<? super S> getter;
	private final CharacterSetter<? super T> setter;
	
 	public CharacterFieldMapper(final CharacterFieldMapperGetter<? super S> getter, final CharacterSetter<? super T> setter) {
		this.getter = getter;
		this.setter = setter;
	}
