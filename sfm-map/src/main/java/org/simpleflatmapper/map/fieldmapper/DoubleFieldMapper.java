...
public final class DoubleFieldMapper<S, T> implements FieldMapper<S, T> {
	...
	private final DoubleFieldMapperGetter<? super S> getter;
	private final DoubleSetter<? super T> setter;
	
 	public DoubleFieldMapper(final DoubleFieldMapperGetter<? super S> getter, final DoubleSetter<? super T> setter) {
		this.getter = getter;
		this.setter = setter;
	}
