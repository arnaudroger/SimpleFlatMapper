...
public class Issue365Test {
    ...
    public void testMapOnCustomSetter() throws IOException {
        ...
        provider.addColumnDefinition(new CaseInsensitiveFieldKeyNamePredicate("benchmark"),
                FieldMapperColumnDefinition.<SampleFieldKey>identity().add(new SetterProperty(new Setter<Data, String>() {
                    @Override
        ...
        MapperConfig<SampleFieldKey, FieldMapperColumnDefinition<SampleFieldKey>> mapperConfig =
                MapperConfig.<SampleFieldKey>fieldMapperConfig().columnDefinitions(provider);
