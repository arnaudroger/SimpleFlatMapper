...
public class AsmFactory {
	...
	private String generateClassNameForInstantiator(final InstantiatorKey key) {
		...
		sb.append( "org.simpleflatmapper.core.reflect.asm.")
	...
	private String generateClassNameForSetter(final Method m) {
		return "org.simpleflatmapper.core.reflect.asm." + (m.getDeclaringClass().getCanonicalName())
					 + "AsmMethodSetter"
                     +"_" + m.getName()+ "_"
    ...
    private String generateClassNameForSetter(final Field field) {
        return "org.simpleflatmapper.core.reflect.asm." + (field.getDeclaringClass().getCanonicalName())
                + "AsmFieldSetter"
                + "_"
                + field.getName()
                + "_"
