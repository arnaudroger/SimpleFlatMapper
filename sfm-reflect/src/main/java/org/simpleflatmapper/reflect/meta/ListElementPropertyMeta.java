...
public class ListElementPropertyMeta<T, E> extends PropertyMeta<T, E> {
    ...
    public ListElementPropertyMeta(String name, Type ownerType, ReflectionService reflectService, int index, ArrayClassMeta<T, E> arrayMetaData, BooleanSupplier isVerticalList) {
