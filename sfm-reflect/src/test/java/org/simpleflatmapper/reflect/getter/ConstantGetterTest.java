...
public class ConstantGetterTest {
    ...
    public void testByte() {
        byte value = (byte) 13;
        assertEquals(value, new ConstantByteGetter<Object>(value).getByte(null));
        assertEquals(value, new ConstantByteGetter<Object>(value).get(null).byteValue());
    }
    @Test
    public void testCharacter() {
        char value = (char) 13;
        assertEquals(value, new ConstantCharacterGetter<Object>(value).getCharacter(null));
        assertEquals(value, new ConstantCharacterGetter<Object>(value).get(null).charValue());
    }
    @Test
    public void testShort() {
        short value = (short) 13;
        assertEquals(value, new ConstantShortGetter<Object>(value).getShort(null));
        assertEquals(value, new ConstantShortGetter<Object>(value).get(null).shortValue());
    }
    @Test
    public void testInteger() {
        int value = 13;
        assertEquals(value, new ConstantIntGetter<Object>(value).getInt(null));
