...
import org.simpleflatmapper.core.tuples.gen.GenerateTuples;
...
public class GenerateTuplesTest {
    ...
    public void testGenerateTuple2() throws IOException {
        ...
        assertEquals(getContent("src/main/java/org/simpleflatmapper/core/tuples/Tuple2.java"), stringWriter.toString());
    }
    ...
    public void testGenerateTuple3() throws IOException {
        ...
        assertEquals(getContent("src/main/java/org/simpleflatmapper/core/tuples/Tuple3.java"), stringWriter.toString());
    }
    ...
    public void testGenerateTuple4() throws IOException {
        ...
        assertEquals(getContent("src/main/java/org/simpleflatmapper/core/tuples/Tuple4.java"), stringWriter.toString());
    }
    @Test
    public void testGenerateTuple5() throws IOException {
        StringWriter stringWriter = new StringWriter();
        GenerateTuples.generateTuple(stringWriter,4, 5, true);
        assertEquals(getContent("src/main/java/org/simpleflatmapper/core/tuples/Tuple5.java"), stringWriter.toString());
    }
