...
public class CachedResultSetMapperBuilder<T> {
	...
	public CachedResultSetMapperBuilder(Class<T> target, Map<String, Setter<T, Object>> setters, SetterFactory setterFactory) {
		this.setters = setters;
		this.setterFactory = setterFactory;
		this.target = target;
		this.primitiveFieldMapperFactory = new PrimitiveFieldMapperFactory<T>(setterFactory);
	}
	
	
	public CachedResultSetMapperBuilder<T> fieldMapperErrorHandler(FieldMapperErrorHandler errorHandler) {
		if (!fields.isEmpty()) {
	...
	public CachedResultSetMapperBuilder<T> mapperBuilderErrorHandler(MapperBuilderErrorHandler errorHandler) {
	...
	public CachedResultSetMapperBuilder<T> addMapping(String property, int column) {
