...
public final class BooleanFieldMapper<S, T> extends AbstractFieldMapper<S, T> {

	private final BooleanGetter<S> getter;
	private final BooleanSetter<T> setter;
	
 	public BooleanFieldMapper(final String name, final BooleanGetter<S> getter, final BooleanSetter<T> setter, final FieldMapperErrorHandler errorHandler) {
