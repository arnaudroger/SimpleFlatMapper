...
public class JdbcMapperAsmBuilder {
	public static <S,T> byte[] dump (final String className, final FieldMapper<S, T>[] mappers, final Class<T> target) throws Exception {
		...
		cw.visit(V1_6, ACC_PUBLIC + ACC_FINAL + ACC_SUPER, classType, "Lorg/sfm/jdbc/AbstractJdbcMapperImpl<L" + targetType + ";>;", "org/sfm/jdbc/AbstractJdbcMapperImpl", null);
...

		{
			...
			mv.visitMethodInsn(INVOKESPECIAL, "org/sfm/jdbc/AbstractJdbcMapperImpl", "<init>", "(Lorg/sfm/reflect/Instantiator;Lorg/sfm/map/RowHandlerErrorHandler;)V", false);
