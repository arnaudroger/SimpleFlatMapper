 ...
 */
public class HibernateStatefullWithCacheBenchmark {



	private SessionFactory sessionFactory;
	public HibernateStatefullWithCacheBenchmark(SessionFactory sessionFactory)  {
	...
	private void runBigSelect() throws Exception {
		...
		Query query = sessionFactory.openSession().createQuery("from DbObject ");
	...
	public static void main(String[] args) throws Exception {
		...
		HibernateStatefullWithCacheBenchmark benchmark = new HibernateStatefullWithCacheBenchmark(sf);
