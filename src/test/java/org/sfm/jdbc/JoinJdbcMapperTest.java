...
public class JoinJdbcMapperTest {
    ...
    public void testJoinTableCNoAsm() throws Exception {
        ...
        assertEquals("DynamicJdbcMapper{target=class org.sfm.jdbc.JoinJdbcMapperTest$ProfessorC, MapperCache{[{ColumnsMapperKey{[id, name, students_id, students_name, students_phones_value]},JoinJdbcMapper{mapper=JdbcMapperImpl{instantiator=InjectConstructorInstantiator{instantiatorDefinition=InstantiatorDefinition{executable=public org.sfm.jdbc.JoinJdbcMapperTest$ProfessorC(int,java.lang.String,java.util.List), parameters=[Parameter{name='id', type=int, resolvedType=int}, Parameter{name='name', type=class java.lang.String, resolvedType=class java.lang.String}, Parameter{name='students', type=interface java.util.List, resolvedType=ParameterizedTypeImpl{rawType=interface java.util.List, types=[class org.sfm.jdbc.JoinJdbcMapperTest$StudentC]}}]}}, fieldMappers=[]}}}]}}",
                mapper.toString());
    }
