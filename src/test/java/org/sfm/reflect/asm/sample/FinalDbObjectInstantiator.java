...
public final class FinalDbObjectInstantiator implements Instantiator<ResultSet, FinalDbObject> {
	...
	@Override
	public FinalDbObject newInstance(ResultSet source) throws Exception {
		return new FinalDbObject(getter_id.getLong(source), getter_name.get(source), (String)getter_email.get(source), null, null, null);
	}
}
