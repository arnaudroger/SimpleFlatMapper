...
#JAVA_OPTS="-XX:+UnlockCommercialFeatures -XX:+FlightRecorder -XX:FlightRecorderOptions=defaultrecording=true,dumponexit=true,dumponexitpath=dynamicnoasmjdbcmapper.jfr"
...
org.sfm.benchmark.sfm.DynamicNoAsmJdbcMapperForEachBenchmark $*
